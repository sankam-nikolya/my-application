...
namespace purchases\widgets\multiInput;
...
class TabularInput extends Widget
{
    ...
    protected function createRenderer()
    {
        ...
        $config = [
            ...
            'data' => $this->models,
            'columnClass' => $this->columnClass ?? TabularColumn::class,
        ...
        if (!$this->rendererClass) {
            $this->rendererClass = TableRenderer::class;
        }

        $config['class'] = $this->rendererClass ?: TableRenderer::class;
